...
public class CollectionTest {
    ...
    @Test
    void mettre_des_null_dans_une_liste_fait_un_NullPointerException_au_runtime() {
        Assertions.assertThrows(NullPointerException.class, () -> {
            List<String> toto = List.of(null);
        });
        Assertions.assertThrows(NullPointerException.class, () -> {
            List<String> toto = new ArrayList<>(null);
        });
    }

    @Test
    void si_la_classe_n_a_pas_de_comparable_alors_un_tree_set_leve_une_ClassCastException_au_runtime() {
        Set<AnimalWithoutComparable> set = new TreeSet<>();
        Assertions.assertThrows(ClassCastException.class, () -> {
            set.add(new AnimalWithoutComparable("Lion"));
        });
